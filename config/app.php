...
use modules\tjckeditorcurcustomizations\TjCkeditorCustomizations;
...
return [
    ...
    'modules' => [
        ...
        'tjckeditorcustomizations' => TjCkeditorCustomizations::class
    ],
    'bootstrap' => ['tjcustomadminnotices', 'tjckeditorcustomizations'],
];
